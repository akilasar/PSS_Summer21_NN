...
def scipy_bicubic(im_f, up_amt):
    with Image.open(im_f) as im:
        print(im.width, im.height)
        print(up_amt)
        return im.resize((im.width*up_amt, im.height*up_amt), resample = PIL.Image.BICUBIC)

# Read image
img = cv2.imread('images/apollo_images/apollo_11_low_def.jpg') #apollo113km.png')
f = 'images/apollo_images/apollo_11_low_def.jpg' #apollo113km.png'
...
dst.save('pilbicubic_apollolowdef.png')
